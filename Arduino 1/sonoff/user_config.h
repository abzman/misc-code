...
#define CFG_HOLDER             0x20161206        // [Reset 1] Change this value to load following default configuration parameters
...
#define STA_SSID1              "i3detroit-wpa"      // [Ssid1] Wifi SSID
#define STA_PASS1              "i3detroit"  // [Password1] Wifi password
...
#define MQTT_FULLTOPIC         "%prefix%/i3/commons/lights/%topic%/" // [FullTopic] Subscribe and Publish full topic name - Legacy topic
...
#define MQTT_TOPIC             "trafficLight"           // [Topic] (unique) MQTT device topic
#define MQTT_GRPTOPIC          "all"         // [GroupTopic] MQTT Group topic
...
#define USE_WEBSERVER                            // Enable web server and wifi manager (+62k code, +8k mem) - Disable by //
  ...
  #define FRIENDLY_NAME        "trafficLight"          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
