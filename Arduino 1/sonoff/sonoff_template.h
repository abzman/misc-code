...
const mytmplt modules[MAXMODULE] PROGMEM = {
  { "Abzman Outlet", // modified eco outlet (ESP8266)
    ...
    0, // GPIO12 HLW8012 CF1 voltage / current
    GPIO_KEY1, // GPIO13 Button
    0, // GPIO14 HLW8012 Sel output
    GPIO_REL1, // GPIO15 Red Led and Relay (0 = Off, 1 = On)
    0, // GPIO16 HLW8012 CF power
  },
  { "Traffic Light",   // traffic light controller, made to work with sonoff 4ch pro pinout
    GPIO_KEY1,        // GPIO00 Button
    GPIO_USER,        // GPIO01 Serial RXD and Optional sensor
    GPIO_USER,        // GPIO02 Optional sensor
    GPIO_USER,        // GPIO03 Serial TXD and Optional sensor
    GPIO_REL3_INV,        // GPIO04 Relay 3 (1 = Off, 0 = On)
    GPIO_REL2_INV,        // GPIO05 Relay 2 (1 = Off, 0 = On)
    0,                // GPIO06 (SD_CLK   Flash)
    0,                // GPIO07 (SD_DATA0 Flash QIO/DIO/DOUT)
    ...
    0,                // GPIO10 (SD_DATA3 Flash QIO)
    0,                // GPIO11 (SD_CMD   Flash)
    GPIO_REL1_INV,        // GPIO12 Relay 1 (1 = Off, 0 = On)
    GPIO_USER,    // GPIO13 Optional sensor
    GPIO_USER,        // GPIO14 Optional sensor
    GPIO_REL4_INV,        // GPIO15 Relay 4 (1 = Off, 0 = On)
    GPIO_LED1_INV,    // GPIO16 Blue Led (0 = On, 1 = Off)
    0                 // ADC0 Analog input
  },
