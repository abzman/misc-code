...
#define MQTT_FULLTOPIC         "%prefix%/i3/inside/classroom/%topic%/" // [FullTopic] Subscribe and Publish full topic name - Legacy topic
...
#define MQTT_TOPIC             "sign"           // [Topic] (unique) MQTT device topic
...
#define USE_WEBSERVER                            // Enable web server and wifi manager (+62k code, +8k mem) - Disable by //
  ...
  #define FRIENDLY_NAME        "classroom sign"          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
