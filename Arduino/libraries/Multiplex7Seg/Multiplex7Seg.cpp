/*
  ...
  History:
  	29/May/09 - V0.5 added support for Atmega2560 (thanks to Manuel Negri)
...
#if defined (__AVR_ATmega168__) || defined (__AVR_ATmega48__) || defined (__AVR_ATmega88__) || defined (__AVR_ATmega328P__) || (__AVR_ATmega2560__)
	TIMSK2 &= ~(1<<TOIE2);
